...
def test_callback_invoked_with_latest_state():
    ...
    sink = ProgressSink(callback=lambda c, t, m: events.append((c, t, m)),
                        total=2, min_interval=0.0)
