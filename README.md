...
For a quick local portable build during development, without creating a ZIP,
checksum, release manifest, or GitHub release assets:
...
- [**CitizenHex/citizenhex-p4k-tools**](https://github.com/CitizenHex/citizenhex-p4k-tools) — CitizenHex-maintained, locally reproducible `unp4k.exe` / `unforge.exe` sources used to unpack `Data.p4k` and convert DataForge to XML; derived from the original [dolkensp/unp4k](https://github.com/dolkensp/unp4k) with prior Osiris performance work retained and credited.
