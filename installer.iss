...
[Files]
Source: "dist\SCLocalizationEditor-v0.6.0.exe"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\SC Localization Editor"; Filename: "{app}\SCLocalizationEditor-v0.6.0.exe"
Name: "{group}\{cm:UninstallProgram,SC Localization Editor}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\SC Localization Editor"; Filename: "{app}\SCLocalizationEditor-v0.6.0.exe"

[Run]
Filename: "{app}\SCLocalizationEditor-v0.6.0.exe"; Description: "{cm:LaunchProgram,SC Localization Editor}"; Flags: nowait postinstall skipifsilent
