...
[Files]
Source: "dist\SCLocalizationEditor-v0.5.3.exe"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\SC Localization Editor"; Filename: "{app}\SCLocalizationEditor-v0.5.3.exe"
Name: "{group}\{cm:UninstallProgram,SC Localization Editor}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\SC Localization Editor"; Filename: "{app}\SCLocalizationEditor-v0.5.3.exe"

[Run]
Filename: "{app}\SCLocalizationEditor-v0.5.3.exe"; Description: "{cm:LaunchProgram,SC Localization Editor}"; Flags: nowait postinstall skipifsilent
