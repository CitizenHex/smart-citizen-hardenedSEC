...
Human-translated except the AI-backfilled keys below (Claude Opus 4.8, 2026-06-04, styled on the existing human strings: vous register, French spacing before `:` `;` `?`, guillemets):
